                ...
                child: Column(
                  children: [
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text("Follow-up to OPD" + patient.followup_to_opd,
                              style: TextStyle(fontWeight: FontWeight.bold)),
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                              "Examination Findings:${patient.examination_remarks}",
                              style: TextStyle(fontWeight: FontWeight.bold))
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text(
                              "Remarks/Follow-up Investigation Details:${patient.remarks_rece}",
                              style: TextStyle(fontWeight: FontWeight.bold)),
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text(
                              "Diagnosis:" + patient.ailment_systems_new ??
                                  "NA",
                              style: TextStyle(fontWeight: FontWeight.bold)),
                          Spacer(
                            flex: 1,
                          ),
                          Text("Ailment System:${patient.ailments_new}",
                              style: TextStyle(fontWeight: FontWeight.bold))
                        ],
                      ),
                    ),
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text("Follow-up:${patient.followup}",
                              style: TextStyle(fontWeight: FontWeight.bold)),
                          Spacer(
                            flex: 1,
                          ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text("Precautions:${patient.remarks}",
                              style: TextStyle(fontWeight: FontWeight.bold)),
                        ],
                      ),
                    ),
